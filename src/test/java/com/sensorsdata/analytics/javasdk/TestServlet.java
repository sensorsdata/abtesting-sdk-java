...
public class TestServlet extends HttpServlet {
  ...
  private static volatile String responseBody = DEFAULT_RESPONSE;

  public static void setResponseBody(String body) {
    responseBody = body;
  }

  public static void resetResponseBody() {
